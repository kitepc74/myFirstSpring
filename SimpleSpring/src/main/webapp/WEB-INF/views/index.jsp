...
<html lang="en">
  ...
  <head>
    ...
    <title>Sumun Yun's first Spring</title>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link" href="/myuse/myblog">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/myuse/about">About</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/myuse/sample">Sample Post</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/myuse/contact">Contact</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('<c:out value="${myContextPath}"/>/resources/assets/img/home-bg.jpg')">
